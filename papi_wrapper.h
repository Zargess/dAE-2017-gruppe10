...
public:
	...
	/** Returns the number of Level 1 total cache misses. */
	long long inline l1_cache_misses() const;
	
	/** Returns the number of Level 1 total cache accesses. */
	long long inline l1_cache_accesses() const;
...
class papi_dAE : public papi_base {
public:
	papi_dAE();
