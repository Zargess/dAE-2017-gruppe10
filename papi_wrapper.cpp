...
void papi_dAE::to_stream( std::ostream& os ) const 
{
  os << l1_cache_misses() << "\t" << l2_cache_misses() << "\t" << l2_cache_accesses() << "\t" << total_instructions() << "\t" << branch_misses();
}
...
papi_cache::papi_cache() {
	this->register_counter( "PAPI_L1_DCM", "L1_total_cache_misses");
	this->register_counter( "PAPI_L2_DCM", "L2_total_cache_misses");
	this->register_counter( "PAPI_L2_DCA", "L2_total_cache_accesses");
	this->register_counter( "PAPI_L3_TCM", "L3_total_cache_misses");
	this->register_counter( "PAPI_L3_TCA", "L3_total_cache_accesses");
}

long long inline papi_cache::l1_cache_misses() const { return values_[ 0 ]; }
long long inline papi_cache::l2_cache_misses() const { return values_[ 1 ]; }
long long inline papi_cache::l2_cache_accesses() const { return values_[ 2 ]; }
long long inline papi_cache::l3_cache_misses() const { return values_[ 3 ]; }
long long inline papi_cache::l3_cache_accesses() const { return values_[ 4 ]; }
...
long long inline papi_dAE::l1_cache_misses() const { return values_[ 0 ]; }
long long inline papi_dAE::l2_cache_misses() const { return values_[ 1 ]; }
long long inline papi_dAE::l2_cache_accesses() const { return values_[ 2 ]; }
long long inline papi_dAE::total_instructions() const { return values_[ 3 ]; }
long long inline papi_dAE::branch_misses() const { return values_[ 4 ]; }
